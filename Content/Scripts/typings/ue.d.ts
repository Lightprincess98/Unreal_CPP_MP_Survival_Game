...
declare type EDefaultGraphicsRHI = 'DefaultGraphicsRHI_Default' | 'DefaultGraphicsRHI_DX11' | 'DefaultGraphicsRHI_DX12' | 'DefaultGraphicsRHI_Vulkan' | 'DefaultGraphicsRHI_OpenGL' | 'DefaultGraphicsRHI_MAX';
declare var EDefaultGraphicsRHI : { DefaultGraphicsRHI_Default:'DefaultGraphicsRHI_Default',DefaultGraphicsRHI_DX11:'DefaultGraphicsRHI_DX11',DefaultGraphicsRHI_DX12:'DefaultGraphicsRHI_DX12',DefaultGraphicsRHI_Vulkan:'DefaultGraphicsRHI_Vulkan',DefaultGraphicsRHI_OpenGL:'DefaultGraphicsRHI_OpenGL',DefaultGraphicsRHI_MAX:'DefaultGraphicsRHI_MAX', };
...
declare class SCharacter extends Character { 
	CameraComp: CameraComponent;
	SpringArmComp: SpringArmComponent;
	static GetDefaultObject(): SCharacter;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): SCharacter;
	static C(Other: UObject | any): SCharacter;
}

declare class SurvivalCPPGameModeBase extends GameModeBase { 
	static GetDefaultObject(): SurvivalCPPGameModeBase;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): SurvivalCPPGameModeBase;
	static C(Other: UObject | any): SurvivalCPPGameModeBase;
}
...
declare class FieldSystemComponent extends PrimitiveComponent { 
	...
	ApplyStayDynamicField(Enabled: boolean,Position: Vector,Radius: number,MaxLevelPerCommand: number): void;
...
declare type EObjectTypeEnum = 'Chaos_Object_Dynamic' | 'Chaos_Object_Kinematic' | 'Chaos_Object_Sleeping' | 'Chaos_Max';
declare var EObjectTypeEnum : { Chaos_Object_Dynamic:'Chaos_Object_Dynamic',Chaos_Object_Kinematic:'Chaos_Object_Kinematic',Chaos_Object_Sleeping:'Chaos_Object_Sleeping',Chaos_Max:'Chaos_Max', };
...
declare type EImplicitTypeEnum = 'Chaos_Implicit_Cube' | 'Chaos_Implicit_Sphere' | 'Chaos_Implicit_LevelSet' | 'Chaos_Max';
declare var EImplicitTypeEnum : { Chaos_Implicit_Cube:'Chaos_Implicit_Cube',Chaos_Implicit_Sphere:'Chaos_Implicit_Sphere',Chaos_Implicit_LevelSet:'Chaos_Implicit_LevelSet',Chaos_Max:'Chaos_Max', };
...
declare class GeometryCollectionDebugDrawComponent extends MeshComponent { 
...
declare class FractureMesh extends UObject { 
	static Load(ResourceName: string): FractureMesh;
	static Find(Outer: UObject, ResourceName: string): FractureMesh;
	static GetDefaultObject(): FractureMesh;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): FractureMesh;
	static C(Other: UObject | any): FractureMesh;
}

declare type EMeshFractureLevel = 'AllLevels' | 'Level0' | 'Level1' | 'Level2' | 'Level3' | 'Level4' | 'Level5' | 'Level6' | 'EMeshFractureLevel_MAX';
declare var EMeshFractureLevel : { AllLevels:'AllLevels',Level0:'Level0',Level1:'Level1',Level2:'Level2',Level3:'Level3',Level4:'Level4',Level5:'Level5',Level6:'Level6',EMeshFractureLevel_MAX:'EMeshFractureLevel_MAX', };
declare type EMeshFractureMode = 'Uniform' | 'Clustered' | 'Radial' | 'Slicing' | 'PlaneCut' | 'EMeshFractureMode_MAX';
declare var EMeshFractureMode : { Uniform:'Uniform',Clustered:'Clustered',Radial:'Radial',Slicing:'Slicing',PlaneCut:'PlaneCut',EMeshFractureMode_MAX:'EMeshFractureMode_MAX', };
declare class CommonFractureSettings extends UObject { 
	ViewMode: EMeshFractureLevel;
	ShowBoneColors: boolean;
	DeleteSourceMesh: boolean;
	FractureMode: EMeshFractureMode;
	RemoveIslands: boolean;
	RandomSeed: number;
	static Load(ResourceName: string): CommonFractureSettings;
	static Find(Outer: UObject, ResourceName: string): CommonFractureSettings;
	static GetDefaultObject(): CommonFractureSettings;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): CommonFractureSettings;
	static C(Other: UObject | any): CommonFractureSettings;
}

declare class UniformFractureSettings extends UObject { 
	NumberVoronoiSites: number;
	static Load(ResourceName: string): UniformFractureSettings;
	static Find(Outer: UObject, ResourceName: string): UniformFractureSettings;
	static GetDefaultObject(): UniformFractureSettings;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): UniformFractureSettings;
	static C(Other: UObject | any): UniformFractureSettings;
}

declare class ClusterFractureSettings extends UObject { 
	NumberClusters: number;
	SitesPerCluster: number;
	ClusterRadius: number;
	static Load(ResourceName: string): ClusterFractureSettings;
	static Find(Outer: UObject, ResourceName: string): ClusterFractureSettings;
	static GetDefaultObject(): ClusterFractureSettings;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): ClusterFractureSettings;
	static C(Other: UObject | any): ClusterFractureSettings;
}

declare class RadialFractureSettings extends UObject { 
	Center: Vector;
	Normal: Vector;
	Radius: number;
	AngularSteps: number;
	...
	AngleOffset: number;
	Variability: number;
	static Load(ResourceName: string): RadialFractureSettings;
	static Find(Outer: UObject, ResourceName: string): RadialFractureSettings;
	static GetDefaultObject(): RadialFractureSettings;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): RadialFractureSettings;
	static C(Other: UObject | any): RadialFractureSettings;
}

declare class SlicingFractureSettings extends UObject { 
	SlicesX: number;
	SlicesY: number;
	SlicesZ: number;
	SliceAngleVariation: number;
	SliceOffsetVariation: number;
	static Load(ResourceName: string): SlicingFractureSettings;
	static Find(Outer: UObject, ResourceName: string): SlicingFractureSettings;
	static GetDefaultObject(): SlicingFractureSettings;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): SlicingFractureSettings;
	static C(Other: UObject | any): SlicingFractureSettings;
}

declare class PlaneCutFractureSettings extends UObject { 
	static Load(ResourceName: string): PlaneCutFractureSettings;
	static Find(Outer: UObject, ResourceName: string): PlaneCutFractureSettings;
	static GetDefaultObject(): PlaneCutFractureSettings;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): PlaneCutFractureSettings;
	static C(Other: UObject | any): PlaneCutFractureSettings;
}

declare class CutoutFractureSettings extends UObject { 
	Transform: Transform;
	Scale: Vector2D;
	...
	CutoutTexture: any;
	static Load(ResourceName: string): CutoutFractureSettings;
	static Find(Outer: UObject, ResourceName: string): CutoutFractureSettings;
	static GetDefaultObject(): CutoutFractureSettings;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): CutoutFractureSettings;
	static C(Other: UObject | any): CutoutFractureSettings;
}

declare class BrickFractureSettings extends UObject { 
	SlicesX: number;
	SlicesY: number;
	SlicesZ: number;
	static Load(ResourceName: string): BrickFractureSettings;
	static Find(Outer: UObject, ResourceName: string): BrickFractureSettings;
	static GetDefaultObject(): BrickFractureSettings;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): BrickFractureSettings;
	static C(Other: UObject | any): BrickFractureSettings;
}

declare class MeshFractureSettings extends UObject { 
	CommonSettings: CommonFractureSettings;
	UniformSettings: UniformFractureSettings;
	ClusterSettings: ClusterFractureSettings;
	RadialSettings: RadialFractureSettings;
	SlicingSettings: SlicingFractureSettings;
	PlaneCutSettings: PlaneCutFractureSettings;
	CutoutSettings: CutoutFractureSettings;
	BrickSettings: BrickFractureSettings;
	static Load(ResourceName: string): MeshFractureSettings;
	static Find(Outer: UObject, ResourceName: string): MeshFractureSettings;
	static GetDefaultObject(): MeshFractureSettings;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): MeshFractureSettings;
	static C(Other: UObject | any): MeshFractureSettings;
}

declare class FractureToolComponent extends ActorComponent { 
	static Load(ResourceName: string): FractureToolComponent;
	static Find(Outer: UObject, ResourceName: string): FractureToolComponent;
	static GetDefaultObject(): FractureToolComponent;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): FractureToolComponent;
	static C(Other: UObject | any): FractureToolComponent;
}
...
declare class MeshEditorGeometryCollectionAdapter extends EditableMeshAdapter { 
	WireframeMesh: WireframeMesh;
	static Load(ResourceName: string): MeshEditorGeometryCollectionAdapter;
	static Find(Outer: UObject, ResourceName: string): MeshEditorGeometryCollectionAdapter;
	static GetDefaultObject(): MeshEditorGeometryCollectionAdapter;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): MeshEditorGeometryCollectionAdapter;
	static C(Other: UObject | any): MeshEditorGeometryCollectionAdapter;
}
...
declare class AutoClusterMeshCommand extends MeshEditorInstantCommand { 
	static Load(ResourceName: string): AutoClusterMeshCommand;
	static Find(Outer: UObject, ResourceName: string): AutoClusterMeshCommand;
	static GetDefaultObject(): AutoClusterMeshCommand;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): AutoClusterMeshCommand;
	static C(Other: UObject | any): AutoClusterMeshCommand;
}
...
declare class ClusterMeshCommand extends MeshEditorInstantCommand { 
	static Load(ResourceName: string): ClusterMeshCommand;
	static Find(Outer: UObject, ResourceName: string): ClusterMeshCommand;
	static GetDefaultObject(): ClusterMeshCommand;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): ClusterMeshCommand;
	static C(Other: UObject | any): ClusterMeshCommand;
}

declare class CollapseAllHierarchyCommand extends MeshEditorInstantCommand { 
	static Load(ResourceName: string): CollapseAllHierarchyCommand;
	static Find(Outer: UObject, ResourceName: string): CollapseAllHierarchyCommand;
	static GetDefaultObject(): CollapseAllHierarchyCommand;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): CollapseAllHierarchyCommand;
	static C(Other: UObject | any): CollapseAllHierarchyCommand;
}

declare class CollapseSelectedHierarchyCommand extends MeshEditorInstantCommand { 
	static Load(ResourceName: string): CollapseSelectedHierarchyCommand;
	static Find(Outer: UObject, ResourceName: string): CollapseSelectedHierarchyCommand;
	static GetDefaultObject(): CollapseSelectedHierarchyCommand;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): CollapseSelectedHierarchyCommand;
	static C(Other: UObject | any): CollapseSelectedHierarchyCommand;
}

declare class ConvertMeshToGeometryCollectionCommand extends MeshEditorInstantCommand { 
	static Load(ResourceName: string): ConvertMeshToGeometryCollectionCommand;
	static Find(Outer: UObject, ResourceName: string): ConvertMeshToGeometryCollectionCommand;
	static GetDefaultObject(): ConvertMeshToGeometryCollectionCommand;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): ConvertMeshToGeometryCollectionCommand;
	static C(Other: UObject | any): ConvertMeshToGeometryCollectionCommand;
}
...
declare class FractureMeshCommand extends MeshEditorInstantCommand { 
	static Load(ResourceName: string): FractureMeshCommand;
	static Find(Outer: UObject, ResourceName: string): FractureMeshCommand;
	static GetDefaultObject(): FractureMeshCommand;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): FractureMeshCommand;
	static C(Other: UObject | any): FractureMeshCommand;
}
...
declare class MergeToClusterCommand extends MeshEditorInstantCommand { 
	static Load(ResourceName: string): MergeToClusterCommand;
	static Find(Outer: UObject, ResourceName: string): MergeToClusterCommand;
	static GetDefaultObject(): MergeToClusterCommand;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): MergeToClusterCommand;
	static C(Other: UObject | any): MergeToClusterCommand;
}
...
declare class SplitMeshCommand extends MeshEditorInstantCommand { 
	static Load(ResourceName: string): SplitMeshCommand;
	static Find(Outer: UObject, ResourceName: string): SplitMeshCommand;
	static GetDefaultObject(): SplitMeshCommand;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): SplitMeshCommand;
	static C(Other: UObject | any): SplitMeshCommand;
}
...
declare class HoudiniAsset extends UObject { 
	AssetFileName: string;
	ThumbnailInfo: ThumbnailInfo;
	AssetImportData: AssetImportData;
	static Load(ResourceName: string): HoudiniAsset;
	static Find(Outer: UObject, ResourceName: string): HoudiniAsset;
	static GetDefaultObject(): HoudiniAsset;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): HoudiniAsset;
	static C(Other: UObject | any): HoudiniAsset;
}

declare class HoudiniAssetComponent extends PrimitiveComponent { 
	bGeneratedDoubleSidedGeometry: boolean;
	GeneratedPhysMaterial: PhysicalMaterial;
	DefaultBodyInstance: BodyInstance;
	GeneratedCollisionTraceFlag: ECollisionTraceFlag;
	GeneratedLightMapResolution: number;
	GeneratedLpvBiasMultiplier: number;
	GeneratedDistanceFieldResolutionScale: number;
	GeneratedWalkableSlopeOverride: WalkableSlopeOverride;
	GeneratedLightMapCoordinateIndex: number;
	bGeneratedUseMaximumStreamingTexelRatio: boolean;
	GeneratedStreamingDistanceMultiplier: number;
	GeneratedFoliageDefaultSettings: FoliageType_InstancedStaticMesh;
	GeneratedAssetUserData: AssetUserData[];
	BakeFolder: string;
	TempCookFolder: string;
	static Load(ResourceName: string): HoudiniAssetComponent;
	static Find(Outer: UObject, ResourceName: string): HoudiniAssetComponent;
	static GetDefaultObject(): HoudiniAssetComponent;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): HoudiniAssetComponent;
	GetAssetId(): number;
	static C(Other: UObject | any): HoudiniAssetComponent;
}

declare class HoudiniAssetActor extends Actor { 
	HoudiniAssetComponent: HoudiniAssetComponent;
	static GetDefaultObject(): HoudiniAssetActor;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): HoudiniAssetActor;
	static C(Other: UObject | any): HoudiniAssetActor;
}

declare class HoudiniAssetComponentMaterials extends UObject { 
	static Load(ResourceName: string): HoudiniAssetComponentMaterials;
	static Find(Outer: UObject, ResourceName: string): HoudiniAssetComponentMaterials;
	static GetDefaultObject(): HoudiniAssetComponentMaterials;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): HoudiniAssetComponentMaterials;
	static C(Other: UObject | any): HoudiniAssetComponentMaterials;
}

declare class HoudiniAssetParameter extends UObject { 
	static Load(ResourceName: string): HoudiniAssetParameter;
	static Find(Outer: UObject, ResourceName: string): HoudiniAssetParameter;
	static GetDefaultObject(): HoudiniAssetParameter;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): HoudiniAssetParameter;
	static C(Other: UObject | any): HoudiniAssetParameter;
}

declare class HoudiniAssetInput extends HoudiniAssetParameter { 
	static Load(ResourceName: string): HoudiniAssetInput;
	static Find(Outer: UObject, ResourceName: string): HoudiniAssetInput;
	static GetDefaultObject(): HoudiniAssetInput;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): HoudiniAssetInput;
	static C(Other: UObject | any): HoudiniAssetInput;
}

declare class HoudiniAssetInstanceInput extends HoudiniAssetParameter { 
	static Load(ResourceName: string): HoudiniAssetInstanceInput;
	static Find(Outer: UObject, ResourceName: string): HoudiniAssetInstanceInput;
	static GetDefaultObject(): HoudiniAssetInstanceInput;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): HoudiniAssetInstanceInput;
	static C(Other: UObject | any): HoudiniAssetInstanceInput;
}

declare class HoudiniAssetInstanceInputField extends UObject { 
	static Load(ResourceName: string): HoudiniAssetInstanceInputField;
	static Find(Outer: UObject, ResourceName: string): HoudiniAssetInstanceInputField;
	static GetDefaultObject(): HoudiniAssetInstanceInputField;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): HoudiniAssetInstanceInputField;
	static C(Other: UObject | any): HoudiniAssetInstanceInputField;
}

declare class HoudiniAssetParameterButton extends HoudiniAssetParameter { 
	static Load(ResourceName: string): HoudiniAssetParameterButton;
	static Find(Outer: UObject, ResourceName: string): HoudiniAssetParameterButton;
	static GetDefaultObject(): HoudiniAssetParameterButton;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): HoudiniAssetParameterButton;
	static C(Other: UObject | any): HoudiniAssetParameterButton;
}

declare class HoudiniAssetParameterChoice extends HoudiniAssetParameter { 
	static Load(ResourceName: string): HoudiniAssetParameterChoice;
	static Find(Outer: UObject, ResourceName: string): HoudiniAssetParameterChoice;
	static GetDefaultObject(): HoudiniAssetParameterChoice;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): HoudiniAssetParameterChoice;
	static C(Other: UObject | any): HoudiniAssetParameterChoice;
}

declare class HoudiniAssetParameterColor extends HoudiniAssetParameter { 
	static Load(ResourceName: string): HoudiniAssetParameterColor;
	static Find(Outer: UObject, ResourceName: string): HoudiniAssetParameterColor;
	static GetDefaultObject(): HoudiniAssetParameterColor;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): HoudiniAssetParameterColor;
	static C(Other: UObject | any): HoudiniAssetParameterColor;
}

declare class HoudiniAssetParameterFile extends HoudiniAssetParameter { 
	static Load(ResourceName: string): HoudiniAssetParameterFile;
	static Find(Outer: UObject, ResourceName: string): HoudiniAssetParameterFile;
	static GetDefaultObject(): HoudiniAssetParameterFile;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): HoudiniAssetParameterFile;
	static C(Other: UObject | any): HoudiniAssetParameterFile;
}

declare class HoudiniAssetParameterFloat extends HoudiniAssetParameter { 
	static Load(ResourceName: string): HoudiniAssetParameterFloat;
	static Find(Outer: UObject, ResourceName: string): HoudiniAssetParameterFloat;
	static GetDefaultObject(): HoudiniAssetParameterFloat;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): HoudiniAssetParameterFloat;
	static C(Other: UObject | any): HoudiniAssetParameterFloat;
}

declare class HoudiniAssetParameterFolder extends HoudiniAssetParameter { 
	static Load(ResourceName: string): HoudiniAssetParameterFolder;
	static Find(Outer: UObject, ResourceName: string): HoudiniAssetParameterFolder;
	static GetDefaultObject(): HoudiniAssetParameterFolder;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): HoudiniAssetParameterFolder;
	static C(Other: UObject | any): HoudiniAssetParameterFolder;
}

declare class HoudiniAssetParameterFolderList extends HoudiniAssetParameter { 
	static Load(ResourceName: string): HoudiniAssetParameterFolderList;
	static Find(Outer: UObject, ResourceName: string): HoudiniAssetParameterFolderList;
	static GetDefaultObject(): HoudiniAssetParameterFolderList;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): HoudiniAssetParameterFolderList;
	static C(Other: UObject | any): HoudiniAssetParameterFolderList;
}

declare class HoudiniAssetParameterInt extends HoudiniAssetParameter { 
	static Load(ResourceName: string): HoudiniAssetParameterInt;
	static Find(Outer: UObject, ResourceName: string): HoudiniAssetParameterInt;
	static GetDefaultObject(): HoudiniAssetParameterInt;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): HoudiniAssetParameterInt;
	static C(Other: UObject | any): HoudiniAssetParameterInt;
}

declare class HoudiniAssetParameterLabel extends HoudiniAssetParameter { 
	static Load(ResourceName: string): HoudiniAssetParameterLabel;
	static Find(Outer: UObject, ResourceName: string): HoudiniAssetParameterLabel;
	static GetDefaultObject(): HoudiniAssetParameterLabel;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): HoudiniAssetParameterLabel;
	static C(Other: UObject | any): HoudiniAssetParameterLabel;
}

declare class HoudiniAssetParameterMultiparm extends HoudiniAssetParameter { 
	static Load(ResourceName: string): HoudiniAssetParameterMultiparm;
	static Find(Outer: UObject, ResourceName: string): HoudiniAssetParameterMultiparm;
	static GetDefaultObject(): HoudiniAssetParameterMultiparm;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): HoudiniAssetParameterMultiparm;
	static C(Other: UObject | any): HoudiniAssetParameterMultiparm;
}

declare class HoudiniAssetParameterRampCurveFloat extends CurveFloat { 
	static Load(ResourceName: string): HoudiniAssetParameterRampCurveFloat;
	static Find(Outer: UObject, ResourceName: string): HoudiniAssetParameterRampCurveFloat;
	static GetDefaultObject(): HoudiniAssetParameterRampCurveFloat;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): HoudiniAssetParameterRampCurveFloat;
	static C(Other: UObject | any): HoudiniAssetParameterRampCurveFloat;
}

declare class HoudiniAssetParameterRampCurveColor extends CurveLinearColor { 
	static Load(ResourceName: string): HoudiniAssetParameterRampCurveColor;
	static Find(Outer: UObject, ResourceName: string): HoudiniAssetParameterRampCurveColor;
	static GetDefaultObject(): HoudiniAssetParameterRampCurveColor;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): HoudiniAssetParameterRampCurveColor;
	static C(Other: UObject | any): HoudiniAssetParameterRampCurveColor;
}

declare class HoudiniAssetParameterRamp extends HoudiniAssetParameterMultiparm { 
	static Load(ResourceName: string): HoudiniAssetParameterRamp;
	static Find(Outer: UObject, ResourceName: string): HoudiniAssetParameterRamp;
	static GetDefaultObject(): HoudiniAssetParameterRamp;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): HoudiniAssetParameterRamp;
	static C(Other: UObject | any): HoudiniAssetParameterRamp;
}

declare class HoudiniAssetParameterSeparator extends HoudiniAssetParameter { 
	static Load(ResourceName: string): HoudiniAssetParameterSeparator;
	static Find(Outer: UObject, ResourceName: string): HoudiniAssetParameterSeparator;
	static GetDefaultObject(): HoudiniAssetParameterSeparator;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): HoudiniAssetParameterSeparator;
	static C(Other: UObject | any): HoudiniAssetParameterSeparator;
}

declare class HoudiniAssetParameterString extends HoudiniAssetParameter { 
	static Load(ResourceName: string): HoudiniAssetParameterString;
	static Find(Outer: UObject, ResourceName: string): HoudiniAssetParameterString;
	static GetDefaultObject(): HoudiniAssetParameterString;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): HoudiniAssetParameterString;
	static C(Other: UObject | any): HoudiniAssetParameterString;
}

declare class HoudiniAssetParameterToggle extends HoudiniAssetParameter { 
	static Load(ResourceName: string): HoudiniAssetParameterToggle;
	static Find(Outer: UObject, ResourceName: string): HoudiniAssetParameterToggle;
	static GetDefaultObject(): HoudiniAssetParameterToggle;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): HoudiniAssetParameterToggle;
	static C(Other: UObject | any): HoudiniAssetParameterToggle;
}

declare class HoudiniAttributeDataComponent extends ActorComponent { 
	static Load(ResourceName: string): HoudiniAttributeDataComponent;
	static Find(Outer: UObject, ResourceName: string): HoudiniAttributeDataComponent;
	static GetDefaultObject(): HoudiniAttributeDataComponent;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): HoudiniAttributeDataComponent;
	static C(Other: UObject | any): HoudiniAttributeDataComponent;
}

declare class HoudiniEngineConvertBgeoCommandlet extends Commandlet { 
	static Load(ResourceName: string): HoudiniEngineConvertBgeoCommandlet;
	static Find(Outer: UObject, ResourceName: string): HoudiniEngineConvertBgeoCommandlet;
	static GetDefaultObject(): HoudiniEngineConvertBgeoCommandlet;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): HoudiniEngineConvertBgeoCommandlet;
	static C(Other: UObject | any): HoudiniEngineConvertBgeoCommandlet;
}

declare class HoudiniEngineConvertBgeoDirCommandlet extends Commandlet { 
	static Load(ResourceName: string): HoudiniEngineConvertBgeoDirCommandlet;
	static Find(Outer: UObject, ResourceName: string): HoudiniEngineConvertBgeoDirCommandlet;
	static GetDefaultObject(): HoudiniEngineConvertBgeoDirCommandlet;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): HoudiniEngineConvertBgeoDirCommandlet;
	static C(Other: UObject | any): HoudiniEngineConvertBgeoDirCommandlet;
}

declare class TestHoudiniParameterBuilder extends UObject { 
	static Load(ResourceName: string): TestHoudiniParameterBuilder;
	static Find(Outer: UObject, ResourceName: string): TestHoudiniParameterBuilder;
	static GetDefaultObject(): TestHoudiniParameterBuilder;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): TestHoudiniParameterBuilder;
	static C(Other: UObject | any): TestHoudiniParameterBuilder;
}

declare type EHoudiniHandleType = 'Xform' | 'Bounder' | 'Unsupported' | 'EHoudiniHandleType_MAX';
declare var EHoudiniHandleType : { Xform:'Xform',Bounder:'Bounder',Unsupported:'Unsupported',EHoudiniHandleType_MAX:'EHoudiniHandleType_MAX', };
declare class HoudiniHandleComponent extends SceneComponent { 
	HandleType: EHoudiniHandleType;
	static Load(ResourceName: string): HoudiniHandleComponent;
	static Find(Outer: UObject, ResourceName: string): HoudiniHandleComponent;
	static GetDefaultObject(): HoudiniHandleComponent;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): HoudiniHandleComponent;
	static C(Other: UObject | any): HoudiniHandleComponent;
}

declare class HoudiniInstancedActorComponent extends SceneComponent { 
	InstancedAsset: UObject;
	Instances: Actor[];
	static Load(ResourceName: string): HoudiniInstancedActorComponent;
	static Find(Outer: UObject, ResourceName: string): HoudiniInstancedActorComponent;
	static GetDefaultObject(): HoudiniInstancedActorComponent;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): HoudiniInstancedActorComponent;
	static C(Other: UObject | any): HoudiniInstancedActorComponent;
}

declare class HoudiniMeshSplitInstancerComponent extends SceneComponent { 
	Instances: StaticMeshComponent[];
	OverrideMaterial: MaterialInterface;
	InstancedMesh: StaticMesh;
	static Load(ResourceName: string): HoudiniMeshSplitInstancerComponent;
	static Find(Outer: UObject, ResourceName: string): HoudiniMeshSplitInstancerComponent;
	static GetDefaultObject(): HoudiniMeshSplitInstancerComponent;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): HoudiniMeshSplitInstancerComponent;
	static C(Other: UObject | any): HoudiniMeshSplitInstancerComponent;
}

declare type EHoudiniRuntimeSettingsSessionType = 'HRSST_InProcess' | 'HRSST_Socket' | 'HRSST_NamedPipe' | 'HRSST_MAX';
declare var EHoudiniRuntimeSettingsSessionType : { HRSST_InProcess:'HRSST_InProcess',HRSST_Socket:'HRSST_Socket',HRSST_NamedPipe:'HRSST_NamedPipe',HRSST_MAX:'HRSST_MAX', };
declare type EHoudiniRuntimeSettingsAxisImport = 'HRSAI_Unreal' | 'HRSAI_Houdini' | 'HRSAI_MAX';
declare var EHoudiniRuntimeSettingsAxisImport : { HRSAI_Unreal:'HRSAI_Unreal',HRSAI_Houdini:'HRSAI_Houdini',HRSAI_MAX:'HRSAI_MAX', };
declare type EHoudiniRuntimeSettingsRecomputeFlag = 'HRSRF_Always' | 'HRSRF_OnlyIfMissing' | 'HRSRF_Nothing' | 'HRSRF_MAX';
declare var EHoudiniRuntimeSettingsRecomputeFlag : { HRSRF_Always:'HRSRF_Always',HRSRF_OnlyIfMissing:'HRSRF_OnlyIfMissing',HRSRF_Nothing:'HRSRF_Nothing',HRSRF_MAX:'HRSRF_MAX', };
declare class HoudiniToolDirectory { 
	Name: string;
	Path: DirectoryPath;
	ContentDirID: string;
	clone() : HoudiniToolDirectory;
	static C(Other: UObject | any): HoudiniToolDirectory;
}

declare class HoudiniRuntimeSettings extends UObject { 
	SessionType: EHoudiniRuntimeSettingsSessionType;
	ServerHost: string;
	ServerPort: number;
	ServerPipeName: string;
	bStartAutomaticServer: boolean;
	AutomaticServerTimeout: number;
	bShowMultiAssetDialog: boolean;
	bPauseCookingOnStart: boolean;
	bEnableCooking: boolean;
	bUploadTransformsToHoudiniEngine: boolean;
	bTransformChangeTriggersCooks: boolean;
	bDisplaySlateCookingNotifications: boolean;
	bCookCurvesOnMouseRelease: boolean;
	TemporaryCookFolder: string;
	bTreatRampParametersAsMultiparms: boolean;
	CollisionGroupNamePrefix: string;
	RenderedCollisionGroupNamePrefix: string;
	UCXCollisionGroupNamePrefix: string;
	UCXRenderedCollisionGroupNamePrefix: string;
	SimpleCollisionGroupNamePrefix: string;
	SimpleRenderedCollisionGroupNamePrefix: string;
	MarshallingAttributeMaterial: string;
	MarshallingAttributeMaterialHole: string;
	MarshallingAttributeInstanceOverride: string;
	MarshallingAttributeFaceSmoothingMask: string;
	MarshallingAttributeLightmapResolution: string;
	MarshallingAttributeGeneratedMeshName: string;
	MarshallingAttributeInputMeshName: string;
	MarshallingAttributeInputSourceFile: string;
	MarshallingSplineResolution: number;
	MarshallingLandscapesUseDefaultUnrealScaling: boolean;
	MarshallingLandscapesUseFullResolution: boolean;
	MarshallingLandscapesForceMinMaxValues: boolean;
	MarshallingLandscapesForcedMinValue: number;
	MarshallingLandscapesForcedMaxValue: number;
	GeneratedGeometryScaleFactor: number;
	TransformScaleFactor: number;
	ImportAxis: EHoudiniRuntimeSettingsAxisImport;
	...
	FoliageDefaultSettings: FoliageType_InstancedStaticMesh;
	...
	MinLightmapResolution: number;
	bRemoveDegenerates: boolean;
	GenerateLightmapUVsFlag: EHoudiniRuntimeSettingsRecomputeFlag;
	RecomputeNormalsFlag: EHoudiniRuntimeSettingsRecomputeFlag;
	RecomputeTangentsFlag: EHoudiniRuntimeSettingsRecomputeFlag;
	bUseMikkTSpace: boolean;
	bBuildAdjacencyBuffer: boolean;
	bUseCustomHoudiniLocation: boolean;
	CustomHoudiniLocation: DirectoryPath;
	bHidePlacementModeHoudiniTools: boolean;
	CustomHoudiniToolsLocation: HoudiniToolDirectory[];
	CookingThreadStackSize: number;
	HoudiniEnvironmentFiles: string;
	OtlSearchPath: string;
	DsoSearchPath: string;
	ImageDsoSearchPath: string;
	AudioDsoSearchPath: string;
	static Load(ResourceName: string): HoudiniRuntimeSettings;
	static Find(Outer: UObject, ResourceName: string): HoudiniRuntimeSettings;
	static GetDefaultObject(): HoudiniRuntimeSettings;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): HoudiniRuntimeSettings;
	static C(Other: UObject | any): HoudiniRuntimeSettings;
}

declare class HoudiniSplineComponent extends SceneComponent { 
	static Load(ResourceName: string): HoudiniSplineComponent;
	static Find(Outer: UObject, ResourceName: string): HoudiniSplineComponent;
	static GetDefaultObject(): HoudiniSplineComponent;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): HoudiniSplineComponent;
	static C(Other: UObject | any): HoudiniSplineComponent;
}
...
declare class BakeSettings extends Info { 
	sliderState: number;
	LightmapAtlasResolution: IntPoint;
	Dilation: number;
	bExportVRScene: boolean;
	ExportVRScenePath: DirectoryPath;
	maxSampleLevel: number;
	noiseThreshold: number;
	lightCacheSubdivs: number;
	retraceThreshold: number;
	Preset: number;
	bBucketSamplerIsEnabled: boolean;
	imageSamplerType: number;
	dmcThreshold: number;
	dmcMinSubdivs: number;
	dmcMaxSubdivs: number;
	static GetDefaultObject(): BakeSettings;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): BakeSettings;
	static C(Other: UObject | any): BakeSettings;
}

declare class VRayProjectSettings extends UObject { 
	vrayTelemetry: string;
	bEnableTelemetry: boolean;
	static Load(ResourceName: string): VRayProjectSettings;
	static Find(Outer: UObject, ResourceName: string): VRayProjectSettings;
	static GetDefaultObject(): VRayProjectSettings;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): VRayProjectSettings;
	static C(Other: UObject | any): VRayProjectSettings;
}

declare class VRayRenderChannelBase extends UObject { 
	static Load(ResourceName: string): VRayRenderChannelBase;
	static Find(Outer: UObject, ResourceName: string): VRayRenderChannelBase;
	static GetDefaultObject(): VRayRenderChannelBase;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): VRayRenderChannelBase;
	static C(Other: UObject | any): VRayRenderChannelBase;
}

declare type EVRayRenderElementTypes = 'NONE' | 'Background' | 'GI' | 'Lighting' | 'Reflection' | 'Refraction' | 'Specular' | 'SelfIllumination' | 'SubSurfaceScatter' | 'Caustics' | 'DiffuseFilter' | 'ReflectionFilter' | 'RefractionFilter' | 'Shadows' | 'Atmosphere' | 'MatteShadow' | 'MultiMatte' | 'RenderID' | 'ObjectID' | 'MaterialID' | 'Normals' | 'BumpNormals' | 'SamplerInfo' | 'Velocity' | 'ZDepth' | 'LightSelect' | 'SampleRate' | 'UnclampedColor' | 'NoiseLevel' | 'UserChannel' | 'EVRayRenderElementTypes_MAX';
declare var EVRayRenderElementTypes : { NONE:'NONE',Background:'Background',GI:'GI',Lighting:'Lighting',Reflection:'Reflection',Refraction:'Refraction',Specular:'Specular',SelfIllumination:'SelfIllumination',SubSurfaceScatter:'SubSurfaceScatter',Caustics:'Caustics',DiffuseFilter:'DiffuseFilter',ReflectionFilter:'ReflectionFilter',RefractionFilter:'RefractionFilter',Shadows:'Shadows',Atmosphere:'Atmosphere',MatteShadow:'MatteShadow',MultiMatte:'MultiMatte',RenderID:'RenderID',ObjectID:'ObjectID',MaterialID:'MaterialID',Normals:'Normals',BumpNormals:'BumpNormals',SamplerInfo:'SamplerInfo',Velocity:'Velocity',ZDepth:'ZDepth',LightSelect:'LightSelect',SampleRate:'SampleRate',UnclampedColor:'UnclampedColor',NoiseLevel:'NoiseLevel',UserChannel:'UserChannel',EVRayRenderElementTypes_MAX:'EVRayRenderElementTypes_MAX', };
declare class VRayRenderElementDataCommon { 
	ChannelName: string;
	Type: EVRayRenderElementTypes;
	bActive: boolean;
	bDenoise: boolean;
	bConsiderForAA: boolean;
	bFiltering: boolean;
	bColorMapping: boolean;
	clone() : VRayRenderElementDataCommon;
	static C(Other: UObject | any): VRayRenderElementDataCommon;
}

declare class VRayRenderChannelSimple extends VRayRenderChannelBase { 
	CommonParameter: VRayRenderElementDataCommon;
	static Load(ResourceName: string): VRayRenderChannelSimple;
	static Find(Outer: UObject, ResourceName: string): VRayRenderChannelSimple;
	static GetDefaultObject(): VRayRenderChannelSimple;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): VRayRenderChannelSimple;
	static C(Other: UObject | any): VRayRenderChannelSimple;
}

declare class VRayRenderChannelBackground extends VRayRenderChannelSimple { 
	static Load(ResourceName: string): VRayRenderChannelBackground;
	static Find(Outer: UObject, ResourceName: string): VRayRenderChannelBackground;
	static GetDefaultObject(): VRayRenderChannelBackground;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): VRayRenderChannelBackground;
	static C(Other: UObject | any): VRayRenderChannelBackground;
}

declare class VRayRenderChannelGlobalIllumination extends VRayRenderChannelSimple { 
	static Load(ResourceName: string): VRayRenderChannelGlobalIllumination;
	static Find(Outer: UObject, ResourceName: string): VRayRenderChannelGlobalIllumination;
	static GetDefaultObject(): VRayRenderChannelGlobalIllumination;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): VRayRenderChannelGlobalIllumination;
	static C(Other: UObject | any): VRayRenderChannelGlobalIllumination;
}

declare class VRayRenderChannelLighting extends VRayRenderChannelSimple { 
	static Load(ResourceName: string): VRayRenderChannelLighting;
	static Find(Outer: UObject, ResourceName: string): VRayRenderChannelLighting;
	static GetDefaultObject(): VRayRenderChannelLighting;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): VRayRenderChannelLighting;
	static C(Other: UObject | any): VRayRenderChannelLighting;
}

declare class VRayRenderChannelReflection extends VRayRenderChannelSimple { 
	static Load(ResourceName: string): VRayRenderChannelReflection;
	static Find(Outer: UObject, ResourceName: string): VRayRenderChannelReflection;
	static GetDefaultObject(): VRayRenderChannelReflection;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): VRayRenderChannelReflection;
	static C(Other: UObject | any): VRayRenderChannelReflection;
}

declare class VRayRenderChannelRefraction extends VRayRenderChannelSimple { 
	static Load(ResourceName: string): VRayRenderChannelRefraction;
	static Find(Outer: UObject, ResourceName: string): VRayRenderChannelRefraction;
	static GetDefaultObject(): VRayRenderChannelRefraction;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): VRayRenderChannelRefraction;
	static C(Other: UObject | any): VRayRenderChannelRefraction;
}

declare class VRayRenderChannelSpecular extends VRayRenderChannelSimple { 
	static Load(ResourceName: string): VRayRenderChannelSpecular;
	static Find(Outer: UObject, ResourceName: string): VRayRenderChannelSpecular;
	static GetDefaultObject(): VRayRenderChannelSpecular;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): VRayRenderChannelSpecular;
	static C(Other: UObject | any): VRayRenderChannelSpecular;
}

declare class VRayRenderChannelSelfIllumination extends VRayRenderChannelSimple { 
	static Load(ResourceName: string): VRayRenderChannelSelfIllumination;
	static Find(Outer: UObject, ResourceName: string): VRayRenderChannelSelfIllumination;
	static GetDefaultObject(): VRayRenderChannelSelfIllumination;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): VRayRenderChannelSelfIllumination;
	static C(Other: UObject | any): VRayRenderChannelSelfIllumination;
}

declare class VRayRenderChannelSubSurfaceScatter extends VRayRenderChannelSimple { 
	static Load(ResourceName: string): VRayRenderChannelSubSurfaceScatter;
	static Find(Outer: UObject, ResourceName: string): VRayRenderChannelSubSurfaceScatter;
	static GetDefaultObject(): VRayRenderChannelSubSurfaceScatter;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): VRayRenderChannelSubSurfaceScatter;
	static C(Other: UObject | any): VRayRenderChannelSubSurfaceScatter;
}

declare class VRayRenderChannelDiffuseFilter extends VRayRenderChannelSimple { 
	static Load(ResourceName: string): VRayRenderChannelDiffuseFilter;
	static Find(Outer: UObject, ResourceName: string): VRayRenderChannelDiffuseFilter;
	static GetDefaultObject(): VRayRenderChannelDiffuseFilter;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): VRayRenderChannelDiffuseFilter;
	static C(Other: UObject | any): VRayRenderChannelDiffuseFilter;
}

declare class VRayRenderChannelReflectionFilter extends VRayRenderChannelSimple { 
	static Load(ResourceName: string): VRayRenderChannelReflectionFilter;
	static Find(Outer: UObject, ResourceName: string): VRayRenderChannelReflectionFilter;
	static GetDefaultObject(): VRayRenderChannelReflectionFilter;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): VRayRenderChannelReflectionFilter;
	static C(Other: UObject | any): VRayRenderChannelReflectionFilter;
}

declare class VRayRenderChannelRefractionFilter extends VRayRenderChannelSimple { 
	static Load(ResourceName: string): VRayRenderChannelRefractionFilter;
	static Find(Outer: UObject, ResourceName: string): VRayRenderChannelRefractionFilter;
	static GetDefaultObject(): VRayRenderChannelRefractionFilter;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): VRayRenderChannelRefractionFilter;
	static C(Other: UObject | any): VRayRenderChannelRefractionFilter;
}

declare class VRayRenderChannelShadows extends VRayRenderChannelSimple { 
	static Load(ResourceName: string): VRayRenderChannelShadows;
	static Find(Outer: UObject, ResourceName: string): VRayRenderChannelShadows;
	static GetDefaultObject(): VRayRenderChannelShadows;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): VRayRenderChannelShadows;
	static C(Other: UObject | any): VRayRenderChannelShadows;
}

declare class VRayRenderChannelAtmosphere extends VRayRenderChannelSimple { 
	static Load(ResourceName: string): VRayRenderChannelAtmosphere;
	static Find(Outer: UObject, ResourceName: string): VRayRenderChannelAtmosphere;
	static GetDefaultObject(): VRayRenderChannelAtmosphere;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): VRayRenderChannelAtmosphere;
	static C(Other: UObject | any): VRayRenderChannelAtmosphere;
}

declare class VRayRenderChannelMatteShadow extends VRayRenderChannelSimple { 
	static Load(ResourceName: string): VRayRenderChannelMatteShadow;
	static Find(Outer: UObject, ResourceName: string): VRayRenderChannelMatteShadow;
	static GetDefaultObject(): VRayRenderChannelMatteShadow;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): VRayRenderChannelMatteShadow;
	static C(Other: UObject | any): VRayRenderChannelMatteShadow;
}

declare class VRayRenderChannelMultiMatte extends VRayRenderChannelSimple { 
	bOutputRedChannel: boolean;
	RedObjectID: any;
	bOutputGreenChannel: boolean;
	GreenObjectID: any;
	bOutputBlueChannel: boolean;
	BlueObjectID: any;
	bUseMaterialID: boolean;
	bAffectMatteObjects: boolean;
	static Load(ResourceName: string): VRayRenderChannelMultiMatte;
	static Find(Outer: UObject, ResourceName: string): VRayRenderChannelMultiMatte;
	static GetDefaultObject(): VRayRenderChannelMultiMatte;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): VRayRenderChannelMultiMatte;
	static C(Other: UObject | any): VRayRenderChannelMultiMatte;
}

declare class VRayRenderChannelRenderID extends VRayRenderChannelSimple { 
	static Load(ResourceName: string): VRayRenderChannelRenderID;
	static Find(Outer: UObject, ResourceName: string): VRayRenderChannelRenderID;
	static GetDefaultObject(): VRayRenderChannelRenderID;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): VRayRenderChannelRenderID;
	static C(Other: UObject | any): VRayRenderChannelRenderID;
}

declare class VRayRenderChannelObjectID extends VRayRenderChannelSimple { 
	static Load(ResourceName: string): VRayRenderChannelObjectID;
	static Find(Outer: UObject, ResourceName: string): VRayRenderChannelObjectID;
	static GetDefaultObject(): VRayRenderChannelObjectID;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): VRayRenderChannelObjectID;
	static C(Other: UObject | any): VRayRenderChannelObjectID;
}

declare class VRayRenderChannelMaterialID extends VRayRenderChannelSimple { 
	static Load(ResourceName: string): VRayRenderChannelMaterialID;
	static Find(Outer: UObject, ResourceName: string): VRayRenderChannelMaterialID;
	static GetDefaultObject(): VRayRenderChannelMaterialID;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): VRayRenderChannelMaterialID;
	static C(Other: UObject | any): VRayRenderChannelMaterialID;
}

declare class VRayRenderChannelNormals extends VRayRenderChannelSimple { 
	static Load(ResourceName: string): VRayRenderChannelNormals;
	static Find(Outer: UObject, ResourceName: string): VRayRenderChannelNormals;
	static GetDefaultObject(): VRayRenderChannelNormals;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): VRayRenderChannelNormals;
	static C(Other: UObject | any): VRayRenderChannelNormals;
}

declare class VRayRenderChannelBumpNormals extends VRayRenderChannelSimple { 
	static Load(ResourceName: string): VRayRenderChannelBumpNormals;
	static Find(Outer: UObject, ResourceName: string): VRayRenderChannelBumpNormals;
	static GetDefaultObject(): VRayRenderChannelBumpNormals;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): VRayRenderChannelBumpNormals;
	static C(Other: UObject | any): VRayRenderChannelBumpNormals;
}

declare type EVRayRenderElementSamplerInfoType = 'Point' | 'CoordinateSystem' | 'NormalVector' | 'ReflectionVector' | 'RefractionVector' | 'NormalVectorWithBumpMapping' | 'BackwardOcclusion' | 'ForwardOcclusion' | 'EVRayRenderElementSamplerInfoType_MAX';
declare var EVRayRenderElementSamplerInfoType : { Point:'Point',CoordinateSystem:'CoordinateSystem',NormalVector:'NormalVector',ReflectionVector:'ReflectionVector',RefractionVector:'RefractionVector',NormalVectorWithBumpMapping:'NormalVectorWithBumpMapping',BackwardOcclusion:'BackwardOcclusion',ForwardOcclusion:'ForwardOcclusion',EVRayRenderElementSamplerInfoType_MAX:'EVRayRenderElementSamplerInfoType_MAX', };
declare type EVRayRenderElementSamplerInfoUVWMode = 'Normal' | 'Clamp' | 'Tile' | 'EVRayRenderElementSamplerInfoUVWMode_MAX';
declare var EVRayRenderElementSamplerInfoUVWMode : { Normal:'Normal',Clamp:'Clamp',Tile:'Tile',EVRayRenderElementSamplerInfoUVWMode_MAX:'EVRayRenderElementSamplerInfoUVWMode_MAX', };
declare type EVRayRenderElementSamplerInfoCoordinateSystem = 'World' | 'Object' | 'Camera' | 'Relative' | 'EVRayRenderElementSamplerInfoCoordinateSystem_MAX';
declare var EVRayRenderElementSamplerInfoCoordinateSystem : { World:'World',Object:'Object',Camera:'Camera',Relative:'Relative',EVRayRenderElementSamplerInfoCoordinateSystem_MAX:'EVRayRenderElementSamplerInfoCoordinateSystem_MAX', };
declare type EVRayRenderElementSamplerInfoOutputType = 'Vector' | 'Color' | 'EVRayRenderElementSamplerInfoOutputType_MAX';
declare var EVRayRenderElementSamplerInfoOutputType : { Vector:'Vector',Color:'Color',EVRayRenderElementSamplerInfoOutputType_MAX:'EVRayRenderElementSamplerInfoOutputType_MAX', };
declare class VRayRenderChannelSamplerInfo extends VRayRenderChannelSimple { 
	Type: EVRayRenderElementSamplerInfoType;
	PointMultiplier: number;
	RefractionIOR: number;
	UVWChannel: any;
	UVWMode: EVRayRenderElementSamplerInfoUVWMode;
	CoordinateSystem: EVRayRenderElementSamplerInfoCoordinateSystem;
	RelativeNode: Actor;
	Output: EVRayRenderElementSamplerInfoOutputType;
	OcclusionBias: number;
	static Load(ResourceName: string): VRayRenderChannelSamplerInfo;
	static Find(Outer: UObject, ResourceName: string): VRayRenderChannelSamplerInfo;
	static GetDefaultObject(): VRayRenderChannelSamplerInfo;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): VRayRenderChannelSamplerInfo;
	static C(Other: UObject | any): VRayRenderChannelSamplerInfo;
}

declare class VRayRenderChannelVelocity extends VRayRenderChannelSimple { 
	bClampVelocity: boolean;
	MaxVelocity: number;
	bIgnoreZDirection: boolean;
	static Load(ResourceName: string): VRayRenderChannelVelocity;
	static Find(Outer: UObject, ResourceName: string): VRayRenderChannelVelocity;
	static GetDefaultObject(): VRayRenderChannelVelocity;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): VRayRenderChannelVelocity;
	static C(Other: UObject | any): VRayRenderChannelVelocity;
}

declare class VRayRenderChannelZDepth extends VRayRenderChannelSimple { 
	DepthRange: FloatRange;
	bClampDepth: boolean;
	bUseCameraDepth: boolean;
	static Load(ResourceName: string): VRayRenderChannelZDepth;
	static Find(Outer: UObject, ResourceName: string): VRayRenderChannelZDepth;
	static GetDefaultObject(): VRayRenderChannelZDepth;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): VRayRenderChannelZDepth;
	static C(Other: UObject | any): VRayRenderChannelZDepth;
}

declare type EVRayRenderElementLightSelectMode = 'DirectIllumination' | 'DirectRaw' | 'DirectDiffuse' | 'DirectSpecular' | 'Full' | 'EVRayRenderElementLightSelectMode_MAX';
declare var EVRayRenderElementLightSelectMode : { DirectIllumination:'DirectIllumination',DirectRaw:'DirectRaw',DirectDiffuse:'DirectDiffuse',DirectSpecular:'DirectSpecular',Full:'Full',EVRayRenderElementLightSelectMode_MAX:'EVRayRenderElementLightSelectMode_MAX', };
declare class VRayRenderChannelLightSelect extends VRayRenderChannelSimple { 
	Mode: EVRayRenderElementLightSelectMode;
	Lights: Light[];
	static Load(ResourceName: string): VRayRenderChannelLightSelect;
	static Find(Outer: UObject, ResourceName: string): VRayRenderChannelLightSelect;
	static GetDefaultObject(): VRayRenderChannelLightSelect;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): VRayRenderChannelLightSelect;
	static C(Other: UObject | any): VRayRenderChannelLightSelect;
}

declare class VRayRenderChannelSampleRate extends VRayRenderChannelSimple { 
	static Load(ResourceName: string): VRayRenderChannelSampleRate;
	static Find(Outer: UObject, ResourceName: string): VRayRenderChannelSampleRate;
	static GetDefaultObject(): VRayRenderChannelSampleRate;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): VRayRenderChannelSampleRate;
	static C(Other: UObject | any): VRayRenderChannelSampleRate;
}

declare class VRayRenderChannelUnclampedColor extends VRayRenderChannelSimple { 
	static Load(ResourceName: string): VRayRenderChannelUnclampedColor;
	static Find(Outer: UObject, ResourceName: string): VRayRenderChannelUnclampedColor;
	static GetDefaultObject(): VRayRenderChannelUnclampedColor;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): VRayRenderChannelUnclampedColor;
	static C(Other: UObject | any): VRayRenderChannelUnclampedColor;
}

declare class VRayRenderChannelNoiseLevel extends VRayRenderChannelSimple { 
	static Load(ResourceName: string): VRayRenderChannelNoiseLevel;
	static Find(Outer: UObject, ResourceName: string): VRayRenderChannelNoiseLevel;
	static GetDefaultObject(): VRayRenderChannelNoiseLevel;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): VRayRenderChannelNoiseLevel;
	static C(Other: UObject | any): VRayRenderChannelNoiseLevel;
}

declare class VRayMaterialBase extends MaterialInstanceConstant { 
	DefaultMeshName: string;
	static Load(ResourceName: string): VRayMaterialBase;
	static Find(Outer: UObject, ResourceName: string): VRayMaterialBase;
	static GetDefaultObject(): VRayMaterialBase;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): VRayMaterialBase;
	static C(Other: UObject | any): VRayMaterialBase;
}

declare class VRayMaterialInstanceConstant extends VRayMaterialBase { 
	vrsceneFilepath: string;
	materialPluginNameSource: string;
	shaderTreeBlob: string;
	bUseStoredPlugins: boolean;
	static Load(ResourceName: string): VRayMaterialInstanceConstant;
	static Find(Outer: UObject, ResourceName: string): VRayMaterialInstanceConstant;
	static GetDefaultObject(): VRayMaterialInstanceConstant;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): VRayMaterialInstanceConstant;
	static C(Other: UObject | any): VRayMaterialInstanceConstant;
}

declare class VRayMaterial extends VRayMaterialBase { 
	static Load(ResourceName: string): VRayMaterial;
	static Find(Outer: UObject, ResourceName: string): VRayMaterial;
	static GetDefaultObject(): VRayMaterial;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): VRayMaterial;
	static C(Other: UObject | any): VRayMaterial;
}

declare class VRayPBRMaterial extends VRayMaterialBase { 
	static Load(ResourceName: string): VRayPBRMaterial;
	static Find(Outer: UObject, ResourceName: string): VRayPBRMaterial;
	static GetDefaultObject(): VRayPBRMaterial;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): VRayPBRMaterial;
	static C(Other: UObject | any): VRayPBRMaterial;
}

declare class VRayCarPaintUberMaterial extends VRayMaterialBase { 
	static Load(ResourceName: string): VRayCarPaintUberMaterial;
	static Find(Outer: UObject, ResourceName: string): VRayCarPaintUberMaterial;
	static GetDefaultObject(): VRayCarPaintUberMaterial;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): VRayCarPaintUberMaterial;
	static C(Other: UObject | any): VRayCarPaintUberMaterial;
}

declare class VRayMeshAssetImportData extends AssetImportData { 
	Scale: number;
	static Load(ResourceName: string): VRayMeshAssetImportData;
	static Find(Outer: UObject, ResourceName: string): VRayMeshAssetImportData;
	static GetDefaultObject(): VRayMeshAssetImportData;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): VRayMeshAssetImportData;
	static C(Other: UObject | any): VRayMeshAssetImportData;
}

declare class VRayPluginComponent extends ActorComponent { 
	PluginName: string;
	static Load(ResourceName: string): VRayPluginComponent;
	static Find(Outer: UObject, ResourceName: string): VRayPluginComponent;
	static GetDefaultObject(): VRayPluginComponent;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): VRayPluginComponent;
	static C(Other: UObject | any): VRayPluginComponent;
}

declare class VRaySceneStaticMeshComponent extends StaticMeshComponent { 
	VRaySceneFileName: string;
	PluginName: string;
	bUseVRaySceneData: boolean;
	VRaySceneData: string;
	static Load(ResourceName: string): VRaySceneStaticMeshComponent;
	static Find(Outer: UObject, ResourceName: string): VRaySceneStaticMeshComponent;
	static GetDefaultObject(): VRaySceneStaticMeshComponent;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): VRaySceneStaticMeshComponent;
	static C(Other: UObject | any): VRaySceneStaticMeshComponent;
}

declare class VRaySceneStaticMeshActor extends StaticMeshActor { 
	static GetDefaultObject(): VRaySceneStaticMeshActor;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): VRaySceneStaticMeshActor;
	static C(Other: UObject | any): VRaySceneStaticMeshActor;
}

declare class ViewportRendererSettings { 
	bEnableViewportRendering: boolean;
	MinSamples: number;
	MinNumPasses: number;
	MinNumTicks: any;
	clone() : ViewportRendererSettings;
	static C(Other: UObject | any): ViewportRendererSettings;
}

declare type ECameraAutoSettings = 'AllViews' | 'ViewsWithoutExposure' | 'ECameraAutoSettings_MAX';
declare var ECameraAutoSettings : { AllViews:'AllViews',ViewsWithoutExposure:'ViewsWithoutExposure',ECameraAutoSettings_MAX:'ECameraAutoSettings_MAX', };
declare class GlobalCameraSettings { 
	AutoCorrectionsMode: ECameraAutoSettings;
	bAutoExposure: boolean;
	bAutoWhiteBalance: boolean;
	clone() : GlobalCameraSettings;
	static C(Other: UObject | any): GlobalCameraSettings;
}
...
declare class RenderSettings { 
	...
	static C(Other: UObject | any): RenderSettings;
}

declare type EVRayGIEngines = 'NONE' | 'BRUTEFORCE' | 'LIGHTCACHE' | 'EVRayGIEngines_MAX';
declare var EVRayGIEngines : { NONE:'NONE',BRUTEFORCE:'BRUTEFORCE',LIGHTCACHE:'LIGHTCACHE',EVRayGIEngines_MAX:'EVRayGIEngines_MAX', };
declare class BruteForceSettings { 
	giDepth: number;
	clone() : BruteForceSettings;
	static C(Other: UObject | any): BruteForceSettings;
}

declare class LightCacheSettings { 
	Subdivs: number;
	SampleSize: number;
	Retrace: number;
	clone() : LightCacheSettings;
	static C(Other: UObject | any): LightCacheSettings;
}

declare class GISettings { 
	GIEngine: EVRayGIEngines;
	BruteForce: BruteForceSettings;
	LightCache: LightCacheSettings;
	clone() : GISettings;
	static C(Other: UObject | any): GISettings;
}

declare class Lights { 
	ShadowBias: number;
	clone() : Lights;
	static C(Other: UObject | any): Lights;
}

declare class Materials { 
	FallbackMaterial: VRayMaterialInstanceConstant;
	clone() : Materials;
	static C(Other: UObject | any): Materials;
}

declare type EVRayDenoiserType = 'NONE' | 'VRAY' | 'NVIDIA' | 'EVRayDenoiserType_MAX';
declare var EVRayDenoiserType : { NONE:'NONE',VRAY:'VRAY',NVIDIA:'NVIDIA',EVRayDenoiserType_MAX:'EVRayDenoiserType_MAX', };
declare type EVRayPostEffectUpdateFrequency = 'HIGH' | 'MEDIUM' | 'NORMAL' | 'DISABLED' | 'EVRayPostEffectUpdateFrequency_MAX';
declare var EVRayPostEffectUpdateFrequency : { HIGH:'HIGH',MEDIUM:'MEDIUM',NORMAL:'NORMAL',DISABLED:'DISABLED',EVRayPostEffectUpdateFrequency_MAX:'EVRayPostEffectUpdateFrequency_MAX', };
declare class RenderElements { 
	Denoiser: EVRayDenoiserType;
	PostEffectUpdateFrequency: EVRayPostEffectUpdateFrequency;
	clone() : RenderElements;
	static C(Other: UObject | any): RenderElements;
}

declare class VRayRenderElementPreset { 
	bEnable: boolean;
	Channels: VRayRenderChannelBase[];
	clone() : VRayRenderElementPreset;
	static C(Other: UObject | any): VRayRenderElementPreset;
}

declare class VRayRenderElementBeautyPreset extends VRayRenderElementPreset { 
	clone() : VRayRenderElementBeautyPreset;
	static C(Other: UObject | any): VRayRenderElementBeautyPreset;
}

declare class VRayRenderElementFilterPreset extends VRayRenderElementPreset { 
	clone() : VRayRenderElementFilterPreset;
	static C(Other: UObject | any): VRayRenderElementFilterPreset;
}

declare class VRayRenderElementMasksPreset extends VRayRenderElementPreset { 
	clone() : VRayRenderElementMasksPreset;
	static C(Other: UObject | any): VRayRenderElementMasksPreset;
}

declare class VRayRenderElementCoordinatesPreset extends VRayRenderElementPreset { 
	clone() : VRayRenderElementCoordinatesPreset;
	static C(Other: UObject | any): VRayRenderElementCoordinatesPreset;
}

declare class VRayRenderElementLightSelectPreset extends VRayRenderElementPreset { 
	clone() : VRayRenderElementLightSelectPreset;
	static C(Other: UObject | any): VRayRenderElementLightSelectPreset;
}

declare class VRayRenderElementUtilsPreset extends VRayRenderElementPreset { 
	clone() : VRayRenderElementUtilsPreset;
	static C(Other: UObject | any): VRayRenderElementUtilsPreset;
}

declare class VRayRenderElementPresets { 
	VRayRenderElementBeauty: VRayRenderElementBeautyPreset;
	VRayRenderElementFilters: VRayRenderElementFilterPreset;
	VRayRenderElementMasks: VRayRenderElementMasksPreset;
	VRayRenderElementCoordinates: VRayRenderElementCoordinatesPreset;
	VRayRenderElementLightSelect: VRayRenderElementLightSelectPreset;
	VRayRenderElementUtils: VRayRenderElementUtilsPreset;
	VRayRenderElementCustomPreset: VRayRenderElementPreset;
	clone() : VRayRenderElementPresets;
	static C(Other: UObject | any): VRayRenderElementPresets;
}

declare class Utilization { 
	LowGPUPriority: boolean;
	Undersampling: any;
	RaysPerPixel: number;
	RaysBundleSize: number;
	TraceDepth: number;
	clone() : Utilization;
	static C(Other: UObject | any): Utilization;
}

declare type ETexturesMode = 'FULLSIZE' | 'RESIZE' | 'ONDEMAND' | 'ETexturesMode_MAX';
declare var ETexturesMode : { FULLSIZE:'FULLSIZE',RESIZE:'RESIZE',ONDEMAND:'ONDEMAND',ETexturesMode_MAX:'ETexturesMode_MAX', };
declare class Textures { 
	Mode: ETexturesMode;
	MaxSize: number;
	clone() : Textures;
	static C(Other: UObject | any): Textures;
}

declare class DistributedRendering { 
	bOn: boolean;
	bUseLocalHost: boolean;
	RenderServers: string[];
	MaxCachedAssetLimit: any;
	clone() : DistributedRendering;
	static C(Other: UObject | any): DistributedRendering;
}

declare class VRaySettings extends Info { 
	bInteractive: boolean;
	bLockRenderView: boolean;
	renderFrom: CameraActor;
	ViewportRendererSettings: ViewportRendererSettings;
	bLockImageAspect: boolean;
	ImageResolution: IntPoint;
	bExportVRScene: boolean;
	ExportVRScenePath: DirectoryPath;
	bCompress: boolean;
	CameraSettings: GlobalCameraSettings;
	...
	VRayRenderElements: VRayRenderElementPresets;
	Utilization: Utilization;
	Textures: Textures;
	DistributedRendering: DistributedRendering;
	static GetDefaultObject(): VRaySettings;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): VRaySettings;
	static C(Other: UObject | any): VRaySettings;
}

declare class DatasmithDataPrepRecipe extends UObject { 
	static Load(ResourceName: string): DatasmithDataPrepRecipe;
	static Find(Outer: UObject, ResourceName: string): DatasmithDataPrepRecipe;
	static GetDefaultObject(): DatasmithDataPrepRecipe;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): DatasmithDataPrepRecipe;
	TriggerPipelineTraversal(): void;
	GetAssets(): UObject[];
	GetActors(): Actor[];
	static C(Other: UObject | any): DatasmithDataPrepRecipe;
}
...
declare type ELandscapeToolFlattenMode = 'Invalid' | 'Both' | 'Raise' | 'Lower' | 'Terrace' | 'ELandscapeToolFlattenMode_MAX';
declare var ELandscapeToolFlattenMode : { Invalid:'Invalid',Both:'Both',Raise:'Raise',Lower:'Lower',Terrace:'Terrace',ELandscapeToolFlattenMode_MAX:'ELandscapeToolFlattenMode_MAX', };
...
declare class LandscapeEditorObject extends UObject { 
	...
	BlueprintCustomBrush: UnrealEngineClass;
...
declare class DatasmithMeshSourceModel { 
	clone() : DatasmithMeshSourceModel;
	static C(Other: UObject | any): DatasmithMeshSourceModel;
}

declare class DatasmithMesh extends UObject { 
	MeshName: string;
	bIsCollisionMesh: boolean;
	SourceModels: DatasmithMeshSourceModel[];
	static Load(ResourceName: string): DatasmithMesh;
	static Find(Outer: UObject, ResourceName: string): DatasmithMesh;
	static GetDefaultObject(): DatasmithMesh;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): DatasmithMesh;
	static C(Other: UObject | any): DatasmithMesh;
}

declare class ActorFactoryDatasmithScene extends ActorFactory { 
	static Load(ResourceName: string): ActorFactoryDatasmithScene;
	static Find(Outer: UObject, ResourceName: string): ActorFactoryDatasmithScene;
	static GetDefaultObject(): ActorFactoryDatasmithScene;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): ActorFactoryDatasmithScene;
	static C(Other: UObject | any): ActorFactoryDatasmithScene;
}

declare class DatasmithBlueprintLibrary extends BlueprintFunctionLibrary { 
	static Load(ResourceName: string): DatasmithBlueprintLibrary;
	static Find(Outer: UObject, ResourceName: string): DatasmithBlueprintLibrary;
	static GetDefaultObject(): DatasmithBlueprintLibrary;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): DatasmithBlueprintLibrary;
	static Import(FilePath: string,PackageName: string,ConfigFilePath: string): void;
	static C(Other: UObject | any): DatasmithBlueprintLibrary;
}

declare class DatasmithObjectElement extends UObject { 
	static Load(ResourceName: string): DatasmithObjectElement;
	static Find(Outer: UObject, ResourceName: string): DatasmithObjectElement;
	static GetDefaultObject(): DatasmithObjectElement;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): DatasmithObjectElement;
	IsElementValid(): boolean;
	GetElementName(): string;
	static C(Other: UObject | any): DatasmithObjectElement;
}

declare type EDatasmithTextureMode = 'Diffuse' | 'Specular' | 'Normal' | 'NormalGreenInv' | 'Displace' | 'Other' | 'Bump' | 'EDatasmithTextureMode_MAX';
declare var EDatasmithTextureMode : { Diffuse:'Diffuse',Specular:'Specular',Normal:'Normal',NormalGreenInv:'NormalGreenInv',Displace:'Displace',Other:'Other',Bump:'Bump',EDatasmithTextureMode_MAX:'EDatasmithTextureMode_MAX', };
declare class DatasmithTextureElement extends DatasmithObjectElement { 
	static Load(ResourceName: string): DatasmithTextureElement;
	static Find(Outer: UObject, ResourceName: string): DatasmithTextureElement;
	static GetDefaultObject(): DatasmithTextureElement;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): DatasmithTextureElement;
	SetTextureMode(Mode: EDatasmithTextureMode): void;
	SetRGBCurve(InRGBCurve: number): void;
	SetFile(File: string): void;
	SetAllowResize(bAllowResize: boolean): void;
	GetTextureMode(): EDatasmithTextureMode;
	GetRGBCurve(): number;
	GetFile(): string;
	GetAllowResize(): boolean;
	static C(Other: UObject | any): DatasmithTextureElement;
}

declare class DatasmithActorElement extends DatasmithObjectElement { 
	static Load(ResourceName: string): DatasmithActorElement;
	static Find(Outer: UObject, ResourceName: string): DatasmithActorElement;
	static GetDefaultObject(): DatasmithActorElement;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): DatasmithActorElement;
	SetVisibility(bInVisibility: boolean): void;
	SetTranslation(Value: Vector): void;
	SetTags(InTags: string[]): void;
	SetScale(Value: Vector): void;
	SetRotation(Value: Quat): void;
	SetLayer(InLayer: string): void;
	SetLabel(InLabel: string): void;
	RemoveChild(InChild: DatasmithActorElement): void;
	...
	GetLabel(): string;
	GetChildrenCount(): number;
	GetChildren(): DatasmithActorElement[];
	AddChild(InChild: DatasmithActorElement): void;
	static C(Other: UObject | any): DatasmithActorElement;
}

declare class DatasmithMaterialIDElement extends DatasmithObjectElement { 
	static Load(ResourceName: string): DatasmithMaterialIDElement;
	static Find(Outer: UObject, ResourceName: string): DatasmithMaterialIDElement;
	static GetDefaultObject(): DatasmithMaterialIDElement;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): DatasmithMaterialIDElement;
	GetId(): number;
	static C(Other: UObject | any): DatasmithMaterialIDElement;
}

declare class DatasmithMeshElement extends DatasmithObjectElement { 
	static Load(ResourceName: string): DatasmithMeshElement;
	static Find(Outer: UObject, ResourceName: string): DatasmithMeshElement;
	static GetDefaultObject(): DatasmithMeshElement;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): DatasmithMeshElement;
	SetMaterial(MaterialName: string,SlotId: number): void;
	SetLightmapSourceUV(UVChannel: number): void;
	SetLightmapCoordinateIndex(UVChannel: number): void;
	GetMaterial(SlotId: number): string;
	GetLightmapSourceUV(): number;
	GetLightmapCoordinateIndex(): number;
	GetLightMapArea(): number;
	GetFile(): string;
	GetBoundingBoxWidth(): number;
	GetBoundingBoxSize(): Vector;
	GetBoundingBoxHeight(): number;
	GetBoundingBoxDepth(): number;
	static C(Other: UObject | any): DatasmithMeshElement;
}

declare class DatasmithMeshActorElement extends DatasmithActorElement { 
	static Load(ResourceName: string): DatasmithMeshActorElement;
	static Find(Outer: UObject, ResourceName: string): DatasmithMeshActorElement;
	static GetDefaultObject(): DatasmithMeshActorElement;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): DatasmithMeshActorElement;
	SetStaticMeshPathName(InStaticMeshName: string): void;
	RemoveMaterialOverride(Material: DatasmithMaterialIDElement): void;
	GetStaticMeshPathName(): string;
	GetMeshElement(): DatasmithMeshElement;
	GetMaterials(): DatasmithMaterialIDElement[];
	GetMaterialOverridesCount(): number;
	GetBoundingBoxSize(): Vector;
	AddMaterialOverride(Material: DatasmithMaterialIDElement): void;
	static C(Other: UObject | any): DatasmithMeshActorElement;
}

declare type EDatasmithActorRemovalRule = 'RemoveChildren' | 'KeepChildrenAndKeepRelativeTransform' | 'EDatasmithActorRemovalRule_MAX';
declare var EDatasmithActorRemovalRule : { RemoveChildren:'RemoveChildren',KeepChildrenAndKeepRelativeTransform:'KeepChildrenAndKeepRelativeTransform',EDatasmithActorRemovalRule_MAX:'EDatasmithActorRemovalRule_MAX', };
declare class DatasmithBaseMaterialElement extends DatasmithObjectElement { 
	static Load(ResourceName: string): DatasmithBaseMaterialElement;
	static Find(Outer: UObject, ResourceName: string): DatasmithBaseMaterialElement;
	static GetDefaultObject(): DatasmithBaseMaterialElement;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): DatasmithBaseMaterialElement;
	static C(Other: UObject | any): DatasmithBaseMaterialElement;
}

declare class DatasmithLightActorElement extends DatasmithActorElement { 
	static Load(ResourceName: string): DatasmithLightActorElement;
	static Find(Outer: UObject, ResourceName: string): DatasmithLightActorElement;
	static GetDefaultObject(): DatasmithLightActorElement;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): DatasmithLightActorElement;
	SetUseTemperature(bUseTemperature: boolean): void;
	SetUseIesBrightness(bUseIESBrightness: boolean): void;
	SetUseIes(bUseIes: boolean): void;
	SetTemperature(Temperature: number): void;
	SetIntensity(Intensity: number): void;
	SetIesFile(IesFile: string): void;
	SetIesBrightnessScale(IESBrightnessScale: number): void;
	SetEnabled(bIsEnabled: boolean): void;
	SetColor(Color: LinearColor): void;
	IsEnabled(): boolean;
	GetUseTemperature(): boolean;
	GetUseIesBrightness(): boolean;
	GetUseIes(): boolean;
	GetTemperature(): number;
	GetIntensity(): number;
	GetIesFile(): string;
	GetIesBrightnessScale(): number;
	GetColor(): LinearColor;
	static C(Other: UObject | any): DatasmithLightActorElement;
}

declare type EDatasmithKeyValuePropertyType = 'String' | 'Color' | 'Float' | 'Bool' | 'Texture' | 'Vector' | 'EDatasmithKeyValuePropertyType_MAX';
declare var EDatasmithKeyValuePropertyType : { String:'String',Color:'Color',Float:'Float',Bool:'Bool',Texture:'Texture',Vector:'Vector',EDatasmithKeyValuePropertyType_MAX:'EDatasmithKeyValuePropertyType_MAX', };
declare class DatasmithKeyValueProperty extends DatasmithObjectElement { 
	static Load(ResourceName: string): DatasmithKeyValueProperty;
	static Find(Outer: UObject, ResourceName: string): DatasmithKeyValueProperty;
	static GetDefaultObject(): DatasmithKeyValueProperty;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): DatasmithKeyValueProperty;
	SetValue(Value: string): void;
	SetPropertyType(InType: EDatasmithKeyValuePropertyType): void;
	GetValue(): string;
	GetPropertyType(): EDatasmithKeyValuePropertyType;
	static C(Other: UObject | any): DatasmithKeyValueProperty;
}

declare class DatasmithCustomActorElement extends DatasmithActorElement { 
	static Load(ResourceName: string): DatasmithCustomActorElement;
	static Find(Outer: UObject, ResourceName: string): DatasmithCustomActorElement;
	static GetDefaultObject(): DatasmithCustomActorElement;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): DatasmithCustomActorElement;
	SetClassOrPathName(InPathName: string): void;
	RemoveProperty(Property: DatasmithKeyValueProperty): void;
	GetPropertyByName(InName: string): DatasmithKeyValueProperty;
	GetProperty(I: number): DatasmithKeyValueProperty;
	GetPropertiesCount(): number;
	GetClassOrPathName(): string;
	AddProperty(Property: DatasmithKeyValueProperty): void;
	static C(Other: UObject | any): DatasmithCustomActorElement;
}

declare class DatasmithPostProcessElement extends DatasmithObjectElement { 
	static Load(ResourceName: string): DatasmithPostProcessElement;
	static Find(Outer: UObject, ResourceName: string): DatasmithPostProcessElement;
	static GetDefaultObject(): DatasmithPostProcessElement;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): DatasmithPostProcessElement;
	SetVignette(Vignette: number): void;
	SetTemperature(Temperature: number): void;
	SetSaturation(Saturation: number): void;
	SetMotionBlur(MotionBlur: number): void;
	SetDof(Dof: number): void;
	SetColorFilter(ColorFilter: LinearColor): void;
	SetCameraShutterSpeed(CameraShutterSpeed: number): void;
	SetCameraISO(CameraISO: number): void;
	GetVignette(): number;
	GetTemperature(): number;
	GetSaturation(): number;
	GetMotionBlur(): number;
	GetDof(): number;
	GetColorFilter(): LinearColor;
	GetCameraShutterSpeed(): number;
	GetCameraISO(): number;
	static C(Other: UObject | any): DatasmithPostProcessElement;
}

declare class DatasmithCameraActorElement extends DatasmithActorElement { 
	static Load(ResourceName: string): DatasmithCameraActorElement;
	static Find(Outer: UObject, ResourceName: string): DatasmithCameraActorElement;
	static GetDefaultObject(): DatasmithCameraActorElement;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): DatasmithCameraActorElement;
	SetSensorWidth(SensorWidth: number): void;
	SetSensorAspectRatio(SensorAspectRatio: number): void;
	SetLookAtActor(ActorPathName: string): void;
	SetFStop(FStop: number): void;
	SetFocusDistance(FocusDistance: number): void;
	SetFocalLength(FocalLength: number): void;
	GetSensorWidth(): number;
	GetSensorAspectRatio(): number;
	GetPostProcess(): DatasmithPostProcessElement;
	GetLookAtActor(): string;
	GetFStop(): number;
	GetFocusDistance(): number;
	GetFocalLength(): number;
	static C(Other: UObject | any): DatasmithCameraActorElement;
}

declare class DatasmithMetaDataElement extends DatasmithObjectElement { 
	static Load(ResourceName: string): DatasmithMetaDataElement;
	static Find(Outer: UObject, ResourceName: string): DatasmithMetaDataElement;
	static GetDefaultObject(): DatasmithMetaDataElement;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): DatasmithMetaDataElement;
	GetPropertyByName(InName: string): DatasmithKeyValueProperty;
	GetProperty(I: number): DatasmithKeyValueProperty;
	GetPropertiesCount(): number;
	GetProperties(OutKeys?: string[],OutValues?: string[]): {OutKeys: string[], OutValues: string[]};
	GetAssociatedElement(): DatasmithObjectElement;
	static C(Other: UObject | any): DatasmithMetaDataElement;
}

declare type EDatasmithActorAttachmentRule = 'KeepRelativeTransform' | 'KeepWorldTransform' | 'EDatasmithActorAttachmentRule_MAX';
declare var EDatasmithActorAttachmentRule : { KeepRelativeTransform:'KeepRelativeTransform',KeepWorldTransform:'KeepWorldTransform',EDatasmithActorAttachmentRule_MAX:'EDatasmithActorAttachmentRule_MAX', };
declare class DatasmithSceneElementBase extends UObject { 
	static Load(ResourceName: string): DatasmithSceneElementBase;
	static Find(Outer: UObject, ResourceName: string): DatasmithSceneElementBase;
	static GetDefaultObject(): DatasmithSceneElementBase;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): DatasmithSceneElementBase;
	RemoveTexture(InElement: DatasmithTextureElement): void;
	RemoveMeshActor(InMeshActor: DatasmithMeshActorElement,RemoveRule: EDatasmithActorRemovalRule): void;
	RemoveMesh(InMesh: DatasmithMeshElement): void;
	RemoveMaterial(InElement: DatasmithBaseMaterialElement): void;
	RemoveLightActor(InLightActor: DatasmithLightActorElement,RemoveRule: EDatasmithActorRemovalRule): void;
	RemoveCustomActor(InCustomActor: DatasmithCustomActorElement,RemoveRule: EDatasmithActorRemovalRule): void;
	RemoveCameraActor(InMeshActor: DatasmithCameraActorElement,RemoveRule: EDatasmithActorRemovalRule): void;
	GetVendor(): string;
	GetUserOS(): string;
	GetUserID(): string;
	GetUsePhysicalSky(): boolean;
	GetTextures(): DatasmithTextureElement[];
	GetProductVersion(): string;
	GetProductName(): string;
	GetPostProcess(): DatasmithPostProcessElement;
	GetMetaDataValueForKey(UObject: DatasmithObjectElement,Key: string): string;
	GetMetaDataKeysAndValuesForValue(UObject: DatasmithObjectElement,StringToMatch: string,OutKeys?: string[],OutValues?: string[]): {OutKeys: string[], OutValues: string[]};
	GetMetaDataForObject(UObject: DatasmithObjectElement): DatasmithMetaDataElement;
	GetMeshes(): DatasmithMeshElement[];
	GetMeshByPathName(MeshPathName: string): DatasmithMeshElement;
	GetMeshActors(): DatasmithMeshActorElement[];
	GetLightActors(): DatasmithLightActorElement[];
	GetHost(): string;
	GetExporterVersion(): string;
	GetExportDuration(): number;
	GetCustomActors(): DatasmithCustomActorElement[];
	GetCameraActors(): DatasmithCameraActorElement[];
	GetAllObjectsAndValuesForKey(Key: string,ObjectClass: UnrealEngineClass,OutObjects?: DatasmithObjectElement[],OutValues?: string[]): {OutObjects: DatasmithObjectElement[], OutValues: string[]};
	GetAllMetaData(ObjectClass: UnrealEngineClass,OutMetadatas?: DatasmithMetaDataElement[]): {OutMetadatas: DatasmithMetaDataElement[]};
	GetAllMeshActors(): DatasmithMeshActorElement[];
	GetAllMaterials(): DatasmithBaseMaterialElement[];
	GetAllLightActors(): DatasmithLightActorElement[];
	GetAllCustomActors(): DatasmithCustomActorElement[];
	GetAllCameraActors(): DatasmithCameraActorElement[];
	CreateTexture(InElementName: string): DatasmithTextureElement;
	CreateMeshActor(InElementName: string): DatasmithMeshActorElement;
	CreateMesh(InElementName: string): DatasmithMeshElement;
	CreateCameraActor(InElementName: string): DatasmithCameraActorElement;
	AttachActorToSceneRoot(NewParent: DatasmithActorElement,AttachmentRule: EDatasmithActorAttachmentRule): void;
	AttachActor(NewParent: DatasmithActorElement,Child: DatasmithActorElement,AttachmentRule: EDatasmithActorAttachmentRule): void;
	static C(Other: UObject | any): DatasmithSceneElementBase;
}

declare class DatasmithImportFactoryCreateFileResult { 
	ImportedActors: Actor[];
	ImportedBlueprint: Blueprint;
	ImportedMeshes: UObject[];
	bImportSucceed: boolean;
	clone() : DatasmithImportFactoryCreateFileResult;
	static C(Other: UObject | any): DatasmithImportFactoryCreateFileResult;
}

declare class DatasmithSceneElement extends DatasmithSceneElementBase { 
	static Load(ResourceName: string): DatasmithSceneElement;
	static Find(Outer: UObject, ResourceName: string): DatasmithSceneElement;
	static GetDefaultObject(): DatasmithSceneElement;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): DatasmithSceneElement;
	ImportScene(DestinationFolder: string,ImportOptions: DatasmithImportBaseOptions): DatasmithImportFactoryCreateFileResult;
	DestroyScene(): void;
	static ConstructDatasmithSceneFromFile(FilePath: string): DatasmithSceneElement;
	static C(Other: UObject | any): DatasmithSceneElement;
}

declare class DatasmithImporterEditorSettings extends UObject { 
	bOfflineImporter: boolean;
	static Load(ResourceName: string): DatasmithImporterEditorSettings;
	static Find(Outer: UObject, ResourceName: string): DatasmithImporterEditorSettings;
	static GetDefaultObject(): DatasmithImporterEditorSettings;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): DatasmithImporterEditorSettings;
	static C(Other: UObject | any): DatasmithImporterEditorSettings;
}

declare class DatasmithImportFactory extends SceneImportFactory { 
	static Load(ResourceName: string): DatasmithImportFactory;
	static Find(Outer: UObject, ResourceName: string): DatasmithImportFactory;
	static GetDefaultObject(): DatasmithImportFactory;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): DatasmithImportFactory;
	static C(Other: UObject | any): DatasmithImportFactory;
}

declare class LODGroupName { 
	Value: string;
	clone() : LODGroupName;
	static C(Other: UObject | any): LODGroupName;
}

declare class DataPrepOperationsLibrary extends BlueprintFunctionLibrary { 
	static Load(ResourceName: string): DataPrepOperationsLibrary;
	static Find(Outer: UObject, ResourceName: string): DataPrepOperationsLibrary;
	static GetDefaultObject(): DataPrepOperationsLibrary;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): DataPrepOperationsLibrary;
	static SubstituteMaterialsByTable(SelectedObjects: UObject[],DataTable: DataTable): void;
	static SubstituteMaterial(SelectedObjects: UObject[],MaterialSearch: string,StringMatch: EEditorScriptingStringMatchType,MaterialSubstitute: MaterialInterface): void;
	static SetSimpleCollision(SelectedObjects: UObject[],ShapeType: EScriptingCollisionShapeType): void;
	static SetMobility(SelectedObjects: UObject[],MobilityType: EComponentMobility): void;
	static SetMaterial(SelectedObjects: UObject[],MaterialSubstitute: MaterialInterface): void;
	static SetLods(SelectedObjects: UObject[],ReductionOptions: EditorScriptingMeshReductionOptions): void;
	static SetLODGroup(SelectedObjects: UObject[],LODGroupName: LODGroupName): void;
	static SetGenerateLightmapUVs(Assets: UObject[],bGenerateLightmapUVs: boolean): void;
	static SetConvexDecompositionCollision(SelectedObjects: UObject[],HullCount: number,MaxHullVerts: number,HullPrecision: number): void;
	static Remove(Objects: UObject[]): void;
	static ComputeLightmapResolution(Objects: UObject[],IdealRatio: number): void;
	static C(Other: UObject | any): DataPrepOperationsLibrary;
}

declare type EDataPrepSizeSource = 'BoundingBoxVolume' | 'EDataPrepSizeSource_MAX';
declare var EDataPrepSizeSource : { BoundingBoxVolume:'BoundingBoxVolume',EDataPrepSizeSource_MAX:'EDataPrepSizeSource_MAX', };
declare type EDataPrepSizeFilterMode = 'SmallerThan' | 'BiggerThan' | 'EDataPrepSizeFilterMode_MAX';
declare var EDataPrepSizeFilterMode : { SmallerThan:'SmallerThan',BiggerThan:'BiggerThan',EDataPrepSizeFilterMode_MAX:'EDataPrepSizeFilterMode_MAX', };
declare class DatasmithDataPrepFilterLibrary extends BlueprintFunctionLibrary { 
	static Load(ResourceName: string): DatasmithDataPrepFilterLibrary;
	static Find(Outer: UObject, ResourceName: string): DatasmithDataPrepFilterLibrary;
	static GetDefaultObject(): DatasmithDataPrepFilterLibrary;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): DatasmithDataPrepFilterLibrary;
	static FilterByTag(TargetArray: Actor[],Tag: string): Actor[];
	static FilterBySize(TargetArray: UObject[],SizeSource: EDataPrepSizeSource,FilterMode: EDataPrepSizeFilterMode,Threshold: number): UObject[];
	static FilterByName(TargetArray: UObject[],NameSubString: string,StringMatch: EEditorScriptingStringMatchType): UObject[];
	static FilterByMetadata(TargetArray: UObject[],Key: string,Value: string,ValueMatch: EEditorScriptingStringMatchType): UObject[];
	static FilterByClass(TargetArray: UObject[],ObjectClass: UnrealEngineClass): UObject[];
	static C(Other: UObject | any): DatasmithDataPrepFilterLibrary;
}

declare class DatasmithGLTFImportFactory extends DatasmithImportFactory { 
	static Load(ResourceName: string): DatasmithGLTFImportFactory;
	static Find(Outer: UObject, ResourceName: string): DatasmithGLTFImportFactory;
	static GetDefaultObject(): DatasmithGLTFImportFactory;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): DatasmithGLTFImportFactory;
	static C(Other: UObject | any): DatasmithGLTFImportFactory;
}

declare class DatasmithGLTFImportOptions extends UObject { 
	bGenerateLightmapUVs: boolean;
	ImportScale: number;
	static Load(ResourceName: string): DatasmithGLTFImportOptions;
	static Find(Outer: UObject, ResourceName: string): DatasmithGLTFImportOptions;
	static GetDefaultObject(): DatasmithGLTFImportOptions;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): DatasmithGLTFImportOptions;
	static C(Other: UObject | any): DatasmithGLTFImportOptions;
}

declare class MDLImporterFactory extends Factory { 
	static Load(ResourceName: string): MDLImporterFactory;
	static Find(Outer: UObject, ResourceName: string): MDLImporterFactory;
	static GetDefaultObject(): MDLImporterFactory;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): MDLImporterFactory;
	static C(Other: UObject | any): MDLImporterFactory;
}

declare class MDLImporterOptions extends UObject { 
	BakingResolution: any;
	BakingSamples: any;
	ResourcesDir: DirectoryPath;
	ModulesDir: DirectoryPath;
	MetersPerSceneUnit: number;
	bUseSampleSize: boolean;
	bForceBaking: boolean;
	static Load(ResourceName: string): MDLImporterOptions;
	static Find(Outer: UObject, ResourceName: string): MDLImporterOptions;
	static GetDefaultObject(): MDLImporterOptions;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): MDLImporterOptions;
	static C(Other: UObject | any): MDLImporterOptions;
}

declare type EJacketingTarget = 'Level' | 'Mesh' | 'EJacketingTarget_MAX';
declare var EJacketingTarget : { Level:'Level',Mesh:'Mesh',EJacketingTarget_MAX:'EJacketingTarget_MAX', };
declare class JacketingOptions extends UObject { 
	Accuracy: number;
	MergeDistance: number;
	Target: EJacketingTarget;
	static Load(ResourceName: string): JacketingOptions;
	static Find(Outer: UObject, ResourceName: string): JacketingOptions;
	static GetDefaultObject(): JacketingOptions;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): JacketingOptions;
	static C(Other: UObject | any): JacketingOptions;
}

declare class MeshProcessingEnterpriseSettings extends UObject { 
	OverrideUndoBufferSize: number;
	static Load(ResourceName: string): MeshProcessingEnterpriseSettings;
	static Find(Outer: UObject, ResourceName: string): MeshProcessingEnterpriseSettings;
	static GetDefaultObject(): MeshProcessingEnterpriseSettings;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): MeshProcessingEnterpriseSettings;
	static C(Other: UObject | any): MeshProcessingEnterpriseSettings;
}

declare class MeshProcessingLibrary extends BlueprintFunctionLibrary { 
	static Load(ResourceName: string): MeshProcessingLibrary;
	static Find(Outer: UObject, ResourceName: string): MeshProcessingLibrary;
	static GetDefaultObject(): MeshProcessingLibrary;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): MeshProcessingLibrary;
	static DefeatureMesh(StaticMesh: StaticMesh,LODIndex: number,Parameters: MeshDefeaturingParameterObject): void;
	static ApplyJacketingOnMeshActors(Actors: Actor[],Options: JacketingOptions,OccludedActorArray?: Actor[]): {OccludedActorArray: Actor[]};
	static C(Other: UObject | any): MeshProcessingLibrary;
}

declare class PolygonToolbarProxyObject extends UObject { 
	static Load(ResourceName: string): PolygonToolbarProxyObject;
	static Find(Outer: UObject, ResourceName: string): PolygonToolbarProxyObject;
	static GetDefaultObject(): PolygonToolbarProxyObject;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): PolygonToolbarProxyObject;
	static C(Other: UObject | any): PolygonToolbarProxyObject;
}

declare class StaticMeshEditorStaticMeshAdapter extends MeshEditorStaticMeshAdapter { 
	static Load(ResourceName: string): StaticMeshEditorStaticMeshAdapter;
	static Find(Outer: UObject, ResourceName: string): StaticMeshEditorStaticMeshAdapter;
	static GetDefaultObject(): StaticMeshEditorStaticMeshAdapter;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): StaticMeshEditorStaticMeshAdapter;
	static C(Other: UObject | any): StaticMeshEditorStaticMeshAdapter;
}

declare class StaticMeshEditorAssetContainer extends DataAsset { 
	HoveredGeometryMaterial: MaterialInterface;
	HoveredFaceMaterial: MaterialInterface;
	WireMaterial: MaterialInterface;
	OverlayLineMaterial: MaterialInterface;
	OverlayPointMaterial: MaterialInterface;
	static Load(ResourceName: string): StaticMeshEditorAssetContainer;
	static Find(Outer: UObject, ResourceName: string): StaticMeshEditorAssetContainer;
	static GetDefaultObject(): StaticMeshEditorAssetContainer;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): StaticMeshEditorAssetContainer;
	static C(Other: UObject | any): StaticMeshEditorAssetContainer;
}
...
declare class PropertyTemplateObject extends UObject { 
	CapturedByteProperty: number;
	CapturedUInt16Property: any;
	CapturedUInt32Property: any;
	CapturedUInt64Property: any;
	CapturedInt8Property: any;
	CapturedInt16Property: any;
	CapturedIntProperty: number;
	CapturedInt64Property: any;
	CapturedFloatProperty: number;
	CapturedDoubleProperty: any;
	...
	static Load(ResourceName: string): PropertyTemplateObject;
	static Find(Outer: UObject, ResourceName: string): PropertyTemplateObject;
	static GetDefaultObject(): PropertyTemplateObject;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): PropertyTemplateObject;
	static C(Other: UObject | any): PropertyTemplateObject;
}

declare class VariantManagerBlueprintLibrary extends BlueprintFunctionLibrary { 
	static Load(ResourceName: string): VariantManagerBlueprintLibrary;
	static Find(Outer: UObject, ResourceName: string): VariantManagerBlueprintLibrary;
	static GetDefaultObject(): VariantManagerBlueprintLibrary;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): VariantManagerBlueprintLibrary;
	static SetPropertyValueVector4(Property: PropertyValue,InValue: Vector4): void;
	static SetPropertyValueVector2D(Property: PropertyValue,InValue: Vector2D): void;
	static SetPropertyValueVector(Property: PropertyValue,InValue: Vector): void;
	static SetPropertyValueString(Property: PropertyValue,InValue: string): void;
	static SetPropertyValueRotator(Property: PropertyValue,InValue: Rotator): void;
	static SetPropertyValueQuat(Property: PropertyValue,InValue: Quat): void;
	static SetPropertyValueObject(Property: PropertyValue,InValue: UObject): void;
	static SetPropertyValueLinearColor(Property: PropertyValue,InValue: LinearColor): void;
	static SetPropertyValueIntPoint(Property: PropertyValue,InValue: IntPoint): void;
	static SetPropertyValueInteger(Property: PropertyValue,InValue: number): void;
	static SetPropertyValueFloat(Property: PropertyValue,InValue: number): void;
	static SetPropertyValueColor(Property: PropertyValue,InValue: Color): void;
	static SetPropertyValueBool(Property: PropertyValue,InValue: boolean): void;
	static RemoveVariantSetFromParent(VariantSet: VariantSet): void;
	static RemoveVariantSetByName(VariantSetName: string,LevelVariantSets: LevelVariantSets): void;
	static RemoveVariantFromParent(Variant: Variant): void;
	static RemoveVariantByName(VariantName: string,VariantSet: VariantSet): void;
	static RemoveCapturedPropertyFromParent(Property: PropertyValue): void;
	static RemoveCapturedPropertyByName(PropertyDisplayName: string,Actor: Actor,Variant: Variant): void;
	static RemoveActorBindingByName(ActorName: string,Variant: Variant): void;
	static RemoveActorBinding(Actor: Actor,Variant: Variant): void;
	static RecordPropertyValue(PropVal: PropertyValue): void;
	static GetPropertyValueVector4(Property: PropertyValue): Vector4;
	static GetPropertyValueVector2D(Property: PropertyValue): Vector2D;
	static GetPropertyValueVector(Property: PropertyValue): Vector;
	static GetPropertyValueString(Property: PropertyValue): string;
	static GetPropertyValueRotator(Property: PropertyValue): Rotator;
	static GetPropertyValueQuat(Property: PropertyValue): Quat;
	static GetPropertyValueObject(Property: PropertyValue): UObject;
	static GetPropertyValueLinearColor(Property: PropertyValue): LinearColor;
	static GetPropertyValueIntPoint(Property: PropertyValue): IntPoint;
	static GetPropertyValueInteger(Property: PropertyValue): number;
	static GetPropertyValueFloat(Property: PropertyValue): number;
	static GetPropertyValueColor(Property: PropertyValue): Color;
	static GetPropertyValueBool(Property: PropertyValue): boolean;
	static GetCapturableProperties(Actor: Actor): CapturableProperty[];
	static CreateLevelVariantSetsAsset(AssetName: string,AssetPath: string): LevelVariantSets;
	static CreateLevelVariantSetsActor(LevelVariantSetsAsset: LevelVariantSets): LevelVariantSetsActor;
	static CaptureProperties(Properties: CapturableProperty[],Actor: Actor,ContainerVariant: Variant): PropertyValue[];
	static ApplyPropertyValue(PropVal: PropertyValue): void;
	static AddVariantSet(VariantSet: VariantSet,LevelVariantSets: LevelVariantSets): void;
	static AddVariant(Variant: Variant,VariantSet: VariantSet): void;
	static AddActorBinding(Actor: Actor,Variant: Variant): void;
	static C(Other: UObject | any): VariantManagerBlueprintLibrary;
}
...
declare class DatasmithCADBlueprintLibrary extends BlueprintFunctionLibrary { 
	static Load(ResourceName: string): DatasmithCADBlueprintLibrary;
	static Find(Outer: UObject, ResourceName: string): DatasmithCADBlueprintLibrary;
	static GetDefaultObject(): DatasmithCADBlueprintLibrary;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): DatasmithCADBlueprintLibrary;
	static Import(FilePath: string,PackageName: string,ConfigFilePath: string): void;
	static C(Other: UObject | any): DatasmithCADBlueprintLibrary;
}

declare type ECADModelCoordSystem = 'ZUp_LeftHanded' | 'ZUp_RightHanded' | 'YUp_LeftHanded' | 'YUp_RightHanded' | 'ECADModelCoordSystem_MAX';
declare var ECADModelCoordSystem : { ZUp_LeftHanded:'ZUp_LeftHanded',ZUp_RightHanded:'ZUp_RightHanded',YUp_LeftHanded:'YUp_LeftHanded',YUp_RightHanded:'YUp_RightHanded',ECADModelCoordSystem_MAX:'ECADModelCoordSystem_MAX', };
declare type ECADPartitionedMeshPolicy = 'Ignore' | 'UseMaterial' | 'UseMesh' | 'ECADPartitionedMeshPolicy_MAX';
declare var ECADPartitionedMeshPolicy : { Ignore:'Ignore',UseMaterial:'UseMaterial',UseMesh:'UseMesh',ECADPartitionedMeshPolicy_MAX:'ECADPartitionedMeshPolicy_MAX', };
declare type ECADUVGeneration = 'Keep' | 'Missing' | 'Always' | 'ECADUVGeneration_MAX';
declare var ECADUVGeneration : { Keep:'Keep',Missing:'Missing',Always:'Always',ECADUVGeneration_MAX:'ECADUVGeneration_MAX', };
declare type EDatasmithGPureUVGenerationMethod = 'UnStitched' | 'Stitched' | 'EDatasmithGPureUVGenerationMethod_MAX';
declare var EDatasmithGPureUVGenerationMethod : { UnStitched:'UnStitched',Stitched:'Stitched',EDatasmithGPureUVGenerationMethod_MAX:'EDatasmithGPureUVGenerationMethod_MAX', };
declare class DatasmithCADImportOptions extends UObject { 
	ModelCoordSys: ECADModelCoordSystem;
	bUseDeltaMesh: boolean;
	bRebuildTopo: boolean;
	bRemoveEmptyObjects: boolean;
	bGenerateFeatureLines: boolean;
	bFindInstances: boolean;
	NumThreads: number;
	PartitionPolicy: ECADPartitionedMeshPolicy;
	UVGeneration: ECADUVGeneration;
	UVGenerationType: EDatasmithGPureUVGenerationMethod;
	bExportParametricData: boolean;
	bSkipMeshTessellation: boolean;
	static Load(ResourceName: string): DatasmithCADImportOptions;
	static Find(Outer: UObject, ResourceName: string): DatasmithCADImportOptions;
	static GetDefaultObject(): DatasmithCADImportOptions;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): DatasmithCADImportOptions;
	static C(Other: UObject | any): DatasmithCADImportOptions;
}

declare class DatasmithCADImportFactory extends DatasmithImportFactory { 
	CADOptions: DatasmithCADImportOptions;
	static Load(ResourceName: string): DatasmithCADImportFactory;
	static Find(Outer: UObject, ResourceName: string): DatasmithCADImportFactory;
	static GetDefaultObject(): DatasmithCADImportFactory;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): DatasmithCADImportFactory;
	static C(Other: UObject | any): DatasmithCADImportFactory;
}

declare class DatasmithCADSceneElement extends DatasmithSceneElementBase { 
	ImportFactory: DatasmithCADImportFactory;
	static Load(ResourceName: string): DatasmithCADSceneElement;
	static Find(Outer: UObject, ResourceName: string): DatasmithCADSceneElement;
	static GetDefaultObject(): DatasmithCADSceneElement;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): DatasmithCADSceneElement;
	static SetMaxNumberThreads(InMaxNumberThreads: number): void;
	ProcessScene(): boolean;
	ImportScene(): DatasmithImportFactoryCreateFileResult;
	GetImportOptions(): DatasmithImportOptions;
	GetCADOptions(): DatasmithCADImportOptions;
	DestroyScene(): void;
	static ConstructDatasmithSceneFromFile(FilePath: string,DestinationFolder: string): DatasmithCADSceneElement;
	static C(Other: UObject | any): DatasmithCADSceneElement;
}

declare class DatasmithCADReimportMeshOptions extends UObject { 
	ImportOptions: DatasmithStaticMeshImportOptions;
	TessellationOptions: DatasmithTessellationOptions;
	static Load(ResourceName: string): DatasmithCADReimportMeshOptions;
	static Find(Outer: UObject, ResourceName: string): DatasmithCADReimportMeshOptions;
	static GetDefaultObject(): DatasmithCADReimportMeshOptions;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): DatasmithCADReimportMeshOptions;
	static C(Other: UObject | any): DatasmithCADReimportMeshOptions;
}
...
declare class EditorAutomationActor extends Actor { 
	static GetDefaultObject(): EditorAutomationActor;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): EditorAutomationActor;
	static C(Other: UObject | any): EditorAutomationActor;
}

declare class EditorAutomationActorComponent extends ActorComponent { 
	static Load(ResourceName: string): EditorAutomationActorComponent;
	static Find(Outer: UObject, ResourceName: string): EditorAutomationActorComponent;
	static GetDefaultObject(): EditorAutomationActorComponent;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): EditorAutomationActorComponent;
	static C(Other: UObject | any): EditorAutomationActorComponent;
}

declare class EditorAutomationObject extends UObject { 
	...
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): EditorAutomationObject;
...
declare class EditorUtilityContext extends UObject { 
	...
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): EditorUtilityContext;
